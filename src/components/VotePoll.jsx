...
const VotingPage = () => {
  ...
  const fetchPoll = async () => {
    try {
      const response = await axios.get(
        `https://vote-backend-five.vercel.app/api/polls/${pollId}`
      );
  ...
  const handleVote = async () => {
    try {
      await axios.post(
        `https://vote-backend-five.vercel.app/api/polls/${pollId}/vote`,
        {
  ...
  const handleReaction = async (reaction) => {
    try {
      const response = await axios.post(
        `https://vote-backend-five.vercel.app/api/polls/${pollId}/react`,
        {
          reaction,
        }
      );
